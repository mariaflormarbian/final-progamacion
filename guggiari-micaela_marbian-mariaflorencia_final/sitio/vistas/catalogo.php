...
<section class="catalogo">
    <h1 class="visually-hidden">Catalogo de nuestros producos disponibles</h1>
        ...
        <li class="card col-md-4 productos">
            <div class="producto">
                ...
                <form action="acciones/agregar-carrito.php"  method="POST" class="w-100 text-center">
                    ...
                    <a class="btn btn-primary mb-2" href="index.php?v=detalle&id=<?= $producto->getCatalogoId();?>">Ver detalle</a>
                </form>
            </div>
        </li>
        <?php
