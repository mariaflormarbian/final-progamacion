                ...
                <div class="navbar-collapse collapse justify-content-md-end" id="bdNavbar">
                    <ul class="navbar-nav flex-md-row flex-wrap bd-navbar-nav pt-2 py-md-0">
                        <li class="nav-item col-6 col-md-auto"><a class="nav-link p-2"
                                href="index.php?v=inicio">Inicio</a></li>
                        <li class="nav-item col-6 col-md-auto"><a class="nav-link p-2"
                                href="index.php?v=catalogo">Productos</a></li>
                        <li class="nav-item col-6 col-md-auto"><a class="nav-link p-2"
                                href="index.php?v=contacto">Contacto</a>
                        </li>

                        <?php
                    if ($autenticacion->estaAutenticado()):
                    ?>
                        <li class="nav-item col-6 col-md-auto"><a class="nav-link p-2" href="index.php?v=carrito"><i
            ...
            <div id="search">
                <form action="index.php" method="get">
                    ...
                    <div class="form-fila">
                        ...
                        <input placeholder="Buscar producto" type="search" id="buscar-producto" name="t"
                            value="<?= $_GET['t'] ?? ''; ?>">
                    </div>
        ...
        <footer class="container-fluid">
            <div class="pt-6">
                <div class="d-flex pt-6 justify-content-center justify-content-md-evenly">
                    <div class="mx-6"><img width="100" src="imgs/otros/logo.png" alt="simpsoneras indumentaria logo"
                            title="exoma remeras logo"></div>
                    <div class="px-6 ">
                        <h3>Encontrános</h3>
                        <ul class="px-0">
                            <li>
                    ...
                    <div class="px-6">
                        ...
                        <ul class="px-0">
                            ...
                            <li>
                                ...
                                <p>Mail: <a href="mailto:info@simpsoneras.com" class="dropdown">info@simpsoneras.com</a>
                                </p>
                            </li>
                        </ul>
                    </div>
                ...
                <ul class="d-flex justify-content-center flex-column flex-md-row">
                    <li class="p-3 text-center"><a class="btn btn-dark border-0" href="index.php?v=catalogo">Sobre
                            Nosotros</a></li>
                    <li class="p-3 text-center"><a class="btn btn-dark border-0"
                            href="index.php?v=catalogo">Showroom</a></li>
                    <li class="p-3 text-center"><a class="btn btn-dark border-0"
                            href="index.php?v=contacto">Contactenos</a></li>
                </ul>
                <div>
